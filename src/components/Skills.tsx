...
import { Brain, Database, BarChart3, Code, Cpu, GitBranch, Sparkles, FunctionSquare } from "lucide-react";
...
const Skills = () => {
  ...
  const skills: Skill[] = [
    ...
    { name: "Linear Programming", category: "Math Optimization", icon: <FunctionSquare className="w-5 h-5" />, description: "Optimization with linear constraints" },
    { name: "MILP", category: "Math Optimization", icon: <FunctionSquare className="w-5 h-5" />, description: "Mixed-integer linear programming" },
    { name: "GurobiPy", category: "Math Optimization", icon: <FunctionSquare className="w-5 h-5" />, description: "Python API for Gurobi solver" },
    { name: "OR-Tools", category: "Math Optimization", icon: <FunctionSquare className="w-5 h-5" />, description: "Google optimization library" },
  ...
  const getCategoryColor = (category: string) => {
    switch(category) {
      ...
      case "Math Optimization": return "from-pink-500/20 to-pink-600/20 hover:from-pink-500/30 hover:to-pink-600/30 border-pink-500/30";
  ...
  return (
    <section id="skills" className="py-10 px-4 scroll-mt-10">
